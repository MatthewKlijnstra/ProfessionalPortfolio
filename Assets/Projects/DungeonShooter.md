...
<section class="info-section">
    ...
    <p>
        It started with the idea to make a realistic gun gameplay and now turend in to a big idea with elemental powers and more.
    </p>
</section>
...
// Example Code Snippet: Lorem Ipsum
