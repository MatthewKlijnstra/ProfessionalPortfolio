...
<h3>VR Weapon Mechanics (Blueprint)</h3>
<div class="feature-segment">
    <div class="code-container">
        <iframe class="bp-render" src="https://blueprintue.com/render/xg9nu93q/" scrolling="no" allowfullscreen style="border: none; width: 100%; height: 100%; min-height: 400px;"></iframe>
    </div>
    <div class="video-container">
        <iframe src="https://www.youtube.com/embed/Q2woZY6K7U4?si=Xp1J0hM9C6w35xQf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
</div>

<h3>Target Logic (Blueprint)</h3>
<div class="feature-segment">
    <div class="code-container">
        <iframe class="bp-render" src="https://blueprintue.com/render/t9j3_rkf/" scrolling="no" allowfullscreen style="border: none; width: 100%; height: 100%; min-height: 400px;"></iframe>
    </div>
    <div class="video-container">
